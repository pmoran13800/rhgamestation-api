...
describe('REST API', function()
{
    ...
    beforeEach(function(done)
    {
        ...
        var source = __dirname + "/share/system/rhgamestation.conf.template";
        var destination = __dirname + "/share/system/rhgamestation.conf";
    ...
    after(function(done)
    {
        // Stop the server
        pm2.connect(function() {
            pm2.stop("rhgamestation-api-test", function(error, proc) {
                pm2.disconnect();
        ...
        it("should return the API homepage", function(done)
        {
            request(baseUrl)
                ...
                .end(function(error, response) {
                    ...
                    response.text.should.equal("RHGamestation API");
                    done();
                });
        });
    });
        ...
        it("should return the hostname from the configuration", function(done)
        {
            request(baseUrl)
                ...
                .end(function(error, response) {
                    ...
                    response.text.should.equal("RHGAMESTATION");
                    done();
                });
        });
        ...
        it("should return the hostname in JSON format", function(done)
        {
            request(baseUrl)
                ...
                .end(function(error, response) {
                    ...
                    expect(response).to.deep.equal({hostname:"RHGAMESTATION"});
                    done();
                });
        });
            ...
            request(baseUrl)
                ...
                .end(function(error, response) {
                    ...
                    xml2js.parseString(response.text, function(error, result) {
                        expect(result.response).to.deep.equal({hostname:["RHGAMESTATION"]});
                        done();
                    });
                });
        });
